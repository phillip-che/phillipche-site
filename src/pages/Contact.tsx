  ...
  const eventTypes = [
    {
      ...
      title: "15 Min Chat",
      description: "Brief conversation or quick question",
      duration: "15 min"
    },
    {
      id: "phillip-che/30-minutes-chat-with-me", 
      title: "30 Min Chat",
      description: "Standard meeting for project discussions",
      duration: "30 min"
    },
    {
      id: "phillip-che/60-minutes-chat-with-me",
      title: "60 Min Chat", 
      description: "In-depth conversation about projects or collaboration",
      duration: "60 min"
    }
  ];
